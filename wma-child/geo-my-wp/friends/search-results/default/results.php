            ...
            <li>         
                ...
                <div class="item">
                    ...
                    <div class="item-title">
                        ...
                        <?php $instruments = xprofile_get_field_data('Instruments Played', $member->ID); 
                        ...
                        <?php echo $member->city . ', ' . $member->state . ', ' . $member->zipcode; ?>
                        <br>
                        <?php $genres = xprofile_get_field_data('Music Genre', $member->ID); 
                        if(count($genres) > 0) {
                            $count = count($genres);
                            for($i = 0; $i < 3 && $i < $count; $i++) {
                                if($i == 2) {
